    ...
    <AtomInner>
      <div class="py-16 xl:py-32">
        ...
        >
          ...
          <span class="glitch text-a-orange" data-text="BIG">BIG</span>
          Thing
        </div>
        ...
        <div class="grid gap-10 py-10 md:grid-cols-2 md:gap-20">
          <a
            href="#"
            class="textMedium custom-transition border border-white px-10 py-6 text-center text-white hover:bg-a-orange hover:text-a-charcoal"
          >
            Discord
          </a>
          <a
