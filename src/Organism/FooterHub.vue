    ...
    <AtomInner>
      <div class="">
        ...
        <div class="grid gap-10 py-10 md:grid-cols-2 md:gap-20">
          <a
            href="#"
            class="textMedium custom-transition rounded-full border border-a-charcoal px-10 py-6 text-center text-a-charcoal hover:bg-a-orange hover:text-a-charcoal"
          >
            Discord
          </a>
          <a
